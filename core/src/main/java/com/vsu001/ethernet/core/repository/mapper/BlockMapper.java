...
public class BlockMapper implements RowMapper<Block> {
   ...
   * basis.
   * <p>
   * The implementation performs the actual work of mapping each row to a result `Block` object.
   * Users do not need to worry about exception handling as SQLExceptions will be caught and handled
