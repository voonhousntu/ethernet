...
import com.vsu001.ethernet.core.model.Contract.Builder;
...
public class ContractMapper implements RowMapper<Contract> {
   ...
   * <code>Contract</code> object. Users do not need to worry about exception handling as
   ...
   * @return The result object, which is of the <code>Contract</code> type for the current row (may
   * be null).
   * @throws SQLException If an SQLException is encountered getting column values.
   */
  @Override
  public Contract mapRow(@NotNull ResultSet resultSet, int i) throws SQLException {
    Builder builder = Contract.newBuilder();
