...
public class TokenTransfersServiceImpl implements GenericService {
  ...
  private static final String CACHE_FILE_NAME = TokenTransferRepository.TABLE_NAME + ".cache";
  ...
  public String doNeo4jImport(String databaseName, UpdateRequest request, String nonce)
    ...
    String importCmd = "import"
        ...
        + " --relationships=TOKEN_TRANSFER=\"/ethernet_assets/headers/token_transfers.csv,"
        + "/ethernet_work_dir/token_transfers_" + nonce + ".csv\"";
