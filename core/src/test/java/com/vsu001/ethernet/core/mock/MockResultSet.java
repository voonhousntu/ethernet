...
public class MockResultSet implements ResultSet {
  ...
  static final DateFormat DATE_ISO_8601 = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
  ...
  /**
   * ResultSet rs = new MockResultSet( "ID,NAME,CITY", "3,John,New York", "4,Bill,Sydney" );
   *
   ...
   * @throws SQLException any exception will be wrapped on SQLException, so that it is not necessary
   *                      to add additional catches to client code.
   */
